...
To see a list of all exported functions, types, and macros, see the [API](/api#api) page.
...
![](snctldu.png){width=600px height=450px}

## Principle of operation {#Principle-of-operation}

### Rendering {#Rendering}

Rendering can occur either to a bitmap (for GL backends) or to a Cairo surface (for CairoMakie).  Both of these have APIs ([`MakieTeX.rasterize`](/api#MakieTeX.rasterize) and [`MakieTeX.draw_to_cairo_surface`](/api#MakieTeX.draw_to_cairo_surface)).
